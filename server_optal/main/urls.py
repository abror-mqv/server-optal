...
from .views import CatApiView, FactoryDetailView, LatestProductsView, SubCategoryDetailView, CategoryDetailView, UpdateFactoryView, RegisterView, CreateProductView, ColorVariationCreateView, FactoryProductsView, ProductDetailView, ProductDeleteView
